...
const loginButton = document.querySelector(".btn3");
...
loginButton.addEventListener("click", function(event) {
    ...
    if (emailInput.trim() === "" || passwordInput.trim() === "") {
        ...
        // Aici puteți adăuga logica pentru validarea credențialelor sau trimiterea datelor către server
        errorMessage.style.display = "none";
        alert("Login successful!");
        // Sau puteți redirecționa utilizatorul către altă pagină
        // window.location.href = "pagina-urmatore.html";
    }
});
